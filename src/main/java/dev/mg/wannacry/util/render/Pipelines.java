...
class Pipelines {
    static final RenderPipeline.Snippet GLOBAL_LINES_SNIPPET = RenderPipeline.builder(MATRICES_FOG_SNIPPET, GLOBALS_SNIPPET)
            .withVertexShader(Identifier.fromNamespaceAndPath("wannacry", "core/rendertype_lines_smooth"))
            .withFragmentShader(Identifier.fromNamespaceAndPath("wannacry", "core/rendertype_lines_smooth"))
